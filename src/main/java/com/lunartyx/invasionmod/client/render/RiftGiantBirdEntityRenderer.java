...
public class RiftGiantBirdEntityRenderer extends MobEntityRenderer<RiftGiantBirdEntity, EntityModel<RiftGiantBirdEntity>> {
    ...
    public RiftGiantBirdEntityRenderer(EntityRendererFactory.Context context) {
        super(context, createModel(context), 0.9F);
    }
